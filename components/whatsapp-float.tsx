export function MessagingFloat({ phone, message }: { phone: string; message?: string }) {
  const href = `tel:+${phone.replace(/[\s+]/g, "")}?text=${encodeURIComponent(message || "Hola! Quiero información")}`
  return (
