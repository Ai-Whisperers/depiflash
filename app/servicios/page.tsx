        ...
        <div className="mt-10 bg-[#F8F0FF] rounded-xl p-6 border border-gray-100">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-gray-600 space-y-2">
              ...
              <p>❌ Si estuviste al sol los días previos, avisame — podemos reprogramar. Idealmente esperá una semana entre exposición solar y sesión.</p>
              <p>✅ Después de la sesión: no te expongas la zona tratada al sol por 48 horas y usá protector solar SPF 50+.</p>
